...
async function captchaSolver(type, apiKey) {
  return type === "2captcha" || type === "1" ? solve2Captcha(apiKey) : solveAntiCaptcha(apiKey);
}
...
async function manageMailAndRegister() {
  ...
  try {
    ...
    const referralCode = ref.toLowerCase() === "n" ? await rl.question("Enter referral code: ") : "1PSC3ZSUV5Y3";
